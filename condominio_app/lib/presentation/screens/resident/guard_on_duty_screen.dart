...
class GuardOnDutyScreen extends StatelessWidget {
            ...
            child: Column(
              ...
              children: [
                const CircleAvatar(
                  ...
                  child: Icon(Icons.security, size: 50, color: Color(0xFF1565C0)),
                ),
                ...
                _InfoRow(icon: Icons.access_time, text: 'Turno: ${guard.shift}'),
                _InfoRow(icon: Icons.phone, text: guard.phone),
                _InfoRow(
                  icon: Icons.circle,
                  text: guard.isOnDuty ? 'En turno actualmente' : 'Fuera de turno',
